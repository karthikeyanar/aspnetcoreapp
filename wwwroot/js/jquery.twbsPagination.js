...
(function($, window, document, undefined) {
    ...
    var TwbsPagination = function(element, options) {
        ...
        this.options.totalPages = Math.ceil(cInt(this.options.total) / cInt(this.options.rowsPerPage));
    ...
    TwbsPagination.prototype = {
        ...
        render: function(pages) {
            ...
            var status = "";
            var from = ((cInt(pages.currentPage) - 1) * cInt(this.options.rowsPerPage) + 1);
            var to = cInt(from) + cInt(this.options.rowsPerPage) - 1;
            var totalRows = this.options.total;
            if (this.options.total < to) {
            ...
            if (this.options.onRender) {
                this.options.onRender(status, this.options.totalPages);
            }
